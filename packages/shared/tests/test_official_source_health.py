"""Deterministic official-observation health classification without requests."""
...
def _row(**overrides):
    return dict({
        ...
        "observed_source_url": "https://example.invalid/source",
        "enabled": True, "status": "succeeded", "cadence_seconds": 3600,
        "retrieved_at": NOW - timedelta(minutes=10),
        "upstream_updated_at": NOW - timedelta(days=30),
