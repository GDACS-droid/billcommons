...
def main() -> int:
    ...
    groups = [
        ["workers/ingest/tests/test_scheduler.py",
         ...
         "workers/ingest/tests/test_official_fl_senate_actions.py",
         "workers/ingest/tests/test_official_factual_benchmark.py",
         "workers/ingest/tests/test_official_fl_senate_capture.py",
         "workers/ingest/tests/test_official_fl_senate_reconciliation.py",
         "workers/ingest/tests/test_official_fl_senate_registration.py",
         ...
         "workers/ingest/tests/test_official_repair_parser_provenance.py",
         "workers/ingest/tests/test_official_repair_bundle.py",
         ...
         "workers/ingest/tests/test_openstates_bulk.py",
